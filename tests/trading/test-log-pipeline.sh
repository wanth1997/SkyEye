...
assert_contains "$TEMPLATE" '\[EXECUTION_REF\]'
...
assert_not_contains "$TEMPLATE" 'grant_id[[:space:]]*='
assert_not_contains "$TEMPLATE" 'mutation_id[[:space:]]*='
assert_not_contains "$TEMPLATE" 'mutations[[:space:]]*='
assert_not_contains "$TEMPLATE" 'account[[:space:]]*='
